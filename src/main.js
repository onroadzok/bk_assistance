...
var winston_logger_1 = require("./common/logger/winston.logger");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core_1.NestFactory.create(app_module_1.AppModule, { logger: winston_logger_1.winstonLogger })];
                case 1:
                    app = _a.sent();
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, app.listen(process.env.PORT || 3002)];
                case 3:
                    _a.sent();
                    console.log("\uD83D\uDE80 Reports service running on port ".concat(process.env.PORT || 3002));
                    return [2 /*return*/];
            }
        });
    });
