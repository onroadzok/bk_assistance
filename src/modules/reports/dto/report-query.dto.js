...
var ReportQueryDto = function () {
    ...
    return _a = /** @class */ (function () {
            function ReportQueryDto() {
                ...
                this.startDate = (__runInitializers(this, _limit_extraInitializers), __runInitializers(this, _startDate_initializers, void 0));
        ...
        (function () {
            ...
            _type_decorators = [(0, swagger_1.ApiProperty)({ required: false, enum: report_entity_1.ReportType }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(report_entity_1.ReportType)];
            _status_decorators = [(0, swagger_1.ApiProperty)({ required: false, enum: report_entity_1.ReportStatus }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(report_entity_1.ReportStatus)];
            _page_decorators = [(0, swagger_1.ApiProperty)({ required: false, default: 1, minimum: 1 }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1)];
            _limit_decorators = [(0, swagger_1.ApiProperty)({ required: false, default: 10, minimum: 1 }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1)];
