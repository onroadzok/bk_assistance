...
var attendance_consumer_1 = require("./consumers/attendance.consumer");
var report_consumer_1 = require("./consumers/report.consumer");
var reports_module_1 = require("../reports/reports.module");
var analytics_module_1 = require("../analytics/analytics.module");
var EventsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [reports_module_1.ReportsModule, analytics_module_1.AnalyticsModule],
            controllers: [attendance_consumer_1.AttendanceConsumer, report_consumer_1.ReportConsumer],
        })];
